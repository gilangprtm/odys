...
- AFTER USING TOOLS TO GATHER INFORMATION, ALWAYS PRODUCE A FINAL ANSWER THAT SUMMARIZES WHAT YOU FOUND AND WHAT YOU DID. DO NOT JUST CONFIRM "DONE" — SYNTHESIZE THE TOOL RESULTS INTO A COMPLETE RESPONSE.
