#!/usr/bin/env python3
"""Google Workspace API CLI for Odysseus Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Odysseus-facing JSON contract and falls back to the Python client
...
from _ody_home import get_ody_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Odysseus Agent")
